      ...
      <header className="sticky top-0 z-20 bg-white border-b border-gray-100 px-4 sm:px-6 h-14 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          >
            ...
            <span className="text-sm font-semibold text-gray-900 hidden sm:block truncate">Bourses & Opportunités</span>
          </Link>
        </div>
      ...
      <div className="flex">
        ...
        <aside className="hidden lg:flex flex-col w-60 h-[calc(100vh-3.5rem)] sticky top-14 border-r border-gray-100 bg-white p-4">
          ...
          <nav className="space-y-1 flex-1 overflow-y-auto min-h-0" aria-label="Navigation principale">
            {[
              ...
              { href: "/opportunities", icon: Award, label: "Bourses & Opportunités", active: true, implemented: true },
        ...
        <main className="flex-1 p-4 sm:p-6 max-w-2xl mx-auto w-full animate-in fade-in slide-in-from-bottom-2 duration-300 ease-out">
          <PostFeed
            ...
            includeTagId={oppTag.id}
            currentUserId={user.id}
            isAdmin={isAdmin}
            memberCount={memberCount ?? 0}
            emptyStateMessage="Aucune opportunité publiée pour l'instant"
            createLabel="Partager une opportunité"
          />
        </main>
      </div>
