...
import { Lock, Eye, EyeOff, Loader2, AlertCircle, ShieldAlert } from "lucide-react";
...
import { forceChangePasswordAction } from "@/actions/admin";
...
export default function ChangePasswordPage() {
  ...
  const onSubmit = (data: ResetPasswordData) => {
    ...
    startTransition(async () => {
      const result = await forceChangePasswordAction(data);
  ...
  return (
    <motion.div
      ...
      // Gradient bordeaux inline (body global = bg-cma-gris, fix flash rouge).
      style={{
        background:
    ...
    >
      ...
      <div className="relative w-full max-w-[380px] mx-auto flex flex-col items-center">
        ...
        >
          ...
          <span>Pour votre sécurité, vous devez changer votre mot de passe temporaire avant de continuer.</span>
        </motion.div>
        ...
        >
          ...
          >
            Choisissez un mot de passe sécurisé et personnel
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <p className="mt-1.5 text-xs" style={{ color: "rgba(245,222,179,0.5)" }}>
